...
def download_data(ticker_lst):
    ...
    for ticker in ticker_lst:
        url = "http://real-chart.finance.yahoo.com/table.csv?s={0}&a=00&b=01&c=2000&d={1}&e={2}&f={3}&g=d&ignore=.csv".format(ticker, today.month-1, today.day-1, today.year)
